...
//import com.example.Spring_IntroThree.Repository.AuthUserRepository;
//import com.example.Spring_IntroThree.Utility.JwtUtil;
...
public class AuthenticationService {
    ...
    public String forgotPassword(String email, String newPassword) {
        ...
        String content = "<h2>Hello " + user.getFirstName() + ",</h2>"
                ...
                + "<p>If you didn't request this, please reset your password immediately.</p>"
                + "<br><p>Regards,</p><p><strong>GreetingsApp Team</strong></p>";
